...
public class SecurityConfig {
   ...
   * @throws JwkException if an error occurs while fetching the JSON Web Key from
   *                      the JwkProvider
   */
  @Bean
  public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity serverHttpSecurity)
    ...
    serverHttpSecurity
        ...
        .and()
        .and()
        .authorizeExchange(exchange -> exchange.pathMatchers("/eureka/**", "/discovery-server/**")
            .permitAll()
            .anyExchange()
            .authenticated());
   ...
   * @throws JwkException          if an error occurs while fetching the JSON Web
   *                               Key from the JwkProvider
