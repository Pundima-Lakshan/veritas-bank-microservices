//package com.veritas.asset.management.api.util;
//
...
//
///**
// * The AssetTestData class is a component that implements the CommandLineRunner
// * interface.
// * It is responsible for populating test data into the
...
//
//    Asset assetItem6 = new Asset();
//    assetItem5.setAssetCode("CAS");
//    assetItem5.setAssetName("Cash");
//    assetItem5.setValue(100000000);
//    assetList.add(assetItem6);
//
